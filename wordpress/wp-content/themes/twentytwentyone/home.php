<?php
/**
 * The template for displaying all home
 *Theme Name : Home
                        ...
                        <div class="col-lg-6 wow fadeInLeft">
                            <div class="img-nr-alhta ml-n20">
                                <div class="fcct-hover">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/partn.jpeg" />
                                </div>
                                <span class="smll-img-al"> <img src="<?php echo get_template_directory_uri(); ?>/img/about2.jpg" /> </span>
                            </div>
                        </div>
                                ...
                                <div class="cont-box-str">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a href="#" class="box-main-ftrs">
                                                <div class="img-container fcct-hover">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/devlopment.jpeg">
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <a href="#" class="box-main-ftrs">
                                                <div class="img-container fcct-hover">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/cloud-serv.jpg">
                                                </div>
                                                <h5 class="equalHeight">
                                                    AWS <br />Services
                                                </h5>
                                        ...
                                        <div class="col-md-3">
                                            <a href="web-development.php" class="box-main-ftrs">
                                                <div class="img-container fcct-hover">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/cyber.jpg">
                                                </div>
                                                <h5 class="equalHeight">
                                                    Web <br> Development
                                                </h5>
