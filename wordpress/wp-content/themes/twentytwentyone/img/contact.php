...
<body class="light">
                            ...
                            <li class="active menu-link" data-menu-bg="companybg">
                                ...
                                <div class="sub-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="o-hidden">
                                                <a href="about.html" class="sub-link">About Mcode</a>
                                            </div>
                                        </li>
										<li>
                                            <div class="o-hidden">
                                ...
                                <div class="o-hidden">
								 ...
								 <div class="sub-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="o-hidden">
                                                <a href="web-development.html" class="sub-link">Web Development</a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="o-hidden">
                                                <a href="application-development.html" class="sub-link">App Developement </a>
                                            </div>
                                        </li>
										<li>
                                            <div class="o-hidden">
                                                <a href="javascript:void(0)" class="sub-link">Web / Graphics Designing  </a>
                                            </div>
                                        </li>
    ...
    <div class="wrapper">
	<div class="main ">
		<section class="page-header bg-img valign parallaxie" data-background="img/contact.jpg"	data-overlay-dark="2">
			<div class="container">
				<div class="row">
					<div class="col-12">
								...
								<form id="contact-form" action="">
									<div class="row">
										...
										<div class="col-12 mt-25">	
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Phone Number" id="" name="Phone">
											</div>
										</div>
										<div class="col-12 mb-25 mt-25">	
											<div class="form-group">
												<textarea name="con_message" class="form-control"  placeholder="Your message"name="Message"></textarea>
											</div>
										</div>
				  ...
				  <div class="col-lg-21 col-md-12 col-sm-12 col-xs-12 ">
					<div class="footer-menu text-center">
								<ul>
									...
									<li><a href="about.html">About Mcode</a></li>
									<li><a href="services.html">Services</a></li>
									<li><a href="contact.html">Contact us</a></li>                
								</ul>
							</div>
							<div class="footer-copyright text-center mt-3">
								<p> © Copyright 2020  <a href="javascript:void(0)">Mcode</a> . All rights reserved.</p>
							</div>
				  </div>
				  </div>
				</div>
		...
		<div id="project-ffotr">
			<div class="project-ffotr">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="content-all-stre">
								<div class="tct-tcr-al">
									...
									<h2> Let’s work <span class="animate-typing" data-animate-loop="true" data-type-speed="200" data-type-delay="200" data-remove-speed="50" data-remove-delay="500" data-cursor-speed="200">
								together
							 </span></h2>
								</div>
				...
				<div class="cycle-move">
					<img src="img/cycle.gif" class="sizr-cuts">
				</div>
			</div>
		</div>
	</footer>
	...
	<script type="text/javascript" src="js/jquery.animateTyping.js"></script>
<script>
